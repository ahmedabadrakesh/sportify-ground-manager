...
const checkoutFormSchema = z.object({
  ...
  address: z
    ...
    .trim()
    .min(1, "Invalid value")
    .refine((val) => val.length >= 10, "Please enter your complete address"),
      ...
      if (data.paymentMethod === "card") {
        try {
          ...
          toast({
            ...
            description:
              "Unable to initialize payment gateway. Please try Cash on Delivery or contact support.",
            variant: "destructive",
          });
          setProcessingOrder(false);
        }
                  ...
                  >
                    ...
                    <form>
                      <script
                        ...
                        data-payment_button_id="pl_RIZUpirdZxBZuW"
                        async
                      ></script>
                    </form>
                  </form>
