      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-700">
                By accessing and using JOKOVA, you accept and agree to be bound
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4 text-gray-700">
                <p>
                  Permission is granted to temporarily access JOKOVA for
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4 text-gray-700">
                <p>When you make a booking through JOKOVA:</p>
                <ul className="list-disc list-inside ml-4 space-y-2">
                  <li>You agree to pay the full amount for the booking</li>
                  <li>
                    Cancellations must be made according to the facility's
                    cancellation policy
                  </li>
                  <li>
                    You are responsible for any damages to the facility during
                    your booking
                  </li>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4 text-gray-700">
                <p>
                  When creating an account with us, you must provide information
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4 text-gray-700">
                <p>
                  JOKOVA acts as a platform connecting users with sports
                  professionals. We are not responsible for the quality, safety,
                  or legality of services provided by sports professionals.
                  Users engage with professionals at their own risk.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-700">
                The materials on JOKOVA are provided on an 'as is' basis. JOKOVA
                makes no warranties, expressed or implied, and hereby disclaim
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-700">
                In no event shall JOKOVA or its suppliers be liable for any
                damages (including, without limitation, damages for loss of data
                or profit, or due to business interruption) arising out of the
                use or inability to use the materials on JOKOVA, even if JOKOVA
